...
document.addEventListener('DOMContentLoaded', () => {
  ...
  validatedForms.forEach(form => {
    form.addEventListener('submit', (e) => {
      ...
      requiredInputs.forEach(input => {
        const errorMsg = (input.closest('.form-group') || input.parentElement).querySelector('.form-error-msg');
        let fieldValid = true;
        ...
        if (input.id === 'confirmPassword' || input.name === 'confirmPassword') {
          const passInput = form.querySelector('#password, #regPassword, [name="password"]');
  ...
  const EYE_OFF_ICON_HTML = '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-eye-off"><path d="M10.733 5.076a10.744 10.744 0 0 1 11.205 6.575 1 1 0 0 1 0 .696 10.747 10.747 0 0 1-1.444 2.49"/><path d="M14.084 14.158a3 3 0 0 1-4.242-4.242"/><path d="M17.479 17.499A10.75 10.75 0 0 1 2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 2.822-4.225"/><line x1="2" x2="22" y1="2" y2="22"/></svg>';
  ...
  passwordToggles.forEach(toggleBtn => {
    toggleBtn.addEventListener('click', (e) => {
      ...
      toggleBtn.innerHTML = isCurrentlyPassword ? EYE_OFF_ICON_HTML : EYE_ICON_HTML;
